...
q_table = numpy.load("./Downloads/taxi/qq_table.npy")
...
""" for i in range(training_episodes):
    ...
    while not done:
        if random.uniform(0, 1) < epsilon:
            action = env.action_space.sample(info["action_mask"]) # Pick a new action for this state.
        else:
...
numpy.save("./Downloads/taxi/qq_table.npy",q_table) """
