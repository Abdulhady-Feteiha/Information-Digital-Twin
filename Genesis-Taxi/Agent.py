...
class Agent():
    ...
    def train(self):
        ...
        for i in range(config.training_episodes):
            ...
            episodes_info_gain.append(calculate_entropy(self.q_table)[0]-past_intropy)
            episodes_entropy.append(calculate_entropy(self.q_table)[0])
